---
title: NumberFormat
description: A number written the way the application's language writes numbers, with figures that line up in a column.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/number-format.json
```

<Stand component="number-format" caption="The same number in four languages, money and percentages, and a column with and without tabular figures." />
