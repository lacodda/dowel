---
title: Dialog
description: A question the reader has to answer before anything else continues.
---
...
<Stand component="dialog" caption="Every size, with a title, a description and a row of actions - in either theme, and in the accent of any product of the line." />
