---
title: Menu
description: A list of actions that opens from a button, with the keyboard already handled.
---
...
<Stand component="menu" caption="Items, a destructive item, a checkbox item, a group with its label, a separator and a submenu - in either theme, and in the accent of any product of the line." />
