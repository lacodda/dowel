---
title: Slider
description: A value picked by position, and a range picked by two - the same component either way.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/slider.json
```

<Stand component="slider" caption="A single value, a range, one with its value shown, and a vertical one." />
