---
title: StatusDot
description: A condition in the space of a character, and the same condition written out - both carrying the word a reader gets in place of the colour.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/status-dot.json
```

<Stand component="status-dot" caption="The five conditions as dots, with and without their words, as badges, and with a shape standing in for the dot." />
