---
title: BarChart
description: Columns over a baseline - one period, one bar - with the plot height stated in pixels.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/bar-chart.json
```

<Stand component="bar-chart" caption="Twelve weeks with a median, a gap in the middle, and one column picked out of the field." />
