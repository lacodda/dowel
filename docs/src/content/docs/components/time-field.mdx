---
title: TimeField
description: A time of day, typed the way people say it - loose going in, one spelling stored.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/time-field.json
```

<Stand component="time-field" caption="Filled, empty, and inside a Field with a hint." />
