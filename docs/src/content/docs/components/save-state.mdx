---
title: SaveState
description: 'The quiet line beside a field that saves itself: saving, then a tick that fades.'
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/save-state.json
```

<Stand component="save-state" caption="Beside a field, the three states, and running." />
