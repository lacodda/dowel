---
title: LineChart
description: A quantity over time, where it continues between the readings - with a hole drawn as a hole.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/line-chart.json
```

<Stand component="line-chart" caption="A balance across a quarter, one week not measured, and the same series forced to a zero floor." />
