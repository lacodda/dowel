---
title: TreeView
description: Folders that open, one tab stop, and the arrow keys a hand-rolled tree leaves out.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/tree-view.json
```

<Stand component="tree-view" caption="A file tree with a selection, and a folder with nothing in it." />
