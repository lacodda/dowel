---
title: PageHeader
description: What a screen says it is - a title, a line under it, and the buttons that act on the whole of it - with the measure its content is read at.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/page-header.json
```

<Stand component="page-header" caption="A screen's heading with actions and a trail under it, and the four measures a container can hold its content to." />
