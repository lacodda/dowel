---
title: Divider
description: The line between one part of a screen and the next - announced as a boundary, or taken out of the reading when it is only drawing - and the heading over a section.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/divider.json
```

<Stand component="divider" caption="A plain rule, a captioned break, a vertical rule in a row of controls, and a section heading with its own actions." />
