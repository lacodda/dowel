---
title: ActionBar
description: 'The strip of actions that belongs to what is on screen, sticky when it needs to be.'
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/action-bar.json
```

<Stand component="action-bar" caption="At the foot of a form, and as groups of editor actions." />
