---
title: Table
description: A table of rows and the heading that reorders them - parts you compose, not a columns prop.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/table.json
```

<Stand component="table" caption="Sortable, the same table in a compact region, with a sticky heading, and empty." />
