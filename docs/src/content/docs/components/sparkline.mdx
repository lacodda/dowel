---
title: Sparkline
description: The shape of a history, small enough to sit beside the number it belongs to.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/sparkline.json
```

<Stand component="sparkline" caption="Beside a total and beside a row, against a stated ceiling and against its own range." />
