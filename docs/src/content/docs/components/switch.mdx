---
title: Switch
description: A setting that takes effect when you flip it - which is what separates it from a checkbox.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/switch.json
```

<Stand component="switch" caption="Off, on, and disabled, with and without words." />
