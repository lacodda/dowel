---
title: InlineField
description: A value edited where it is shown - click, type, Enter or leave to keep, Escape to take it back.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/inline-field.json
```

<Stand component="inline-field" caption="A work's fields - a number, a key, a timecode, an empty one - and cells named only by their column." />
