---
title: SkeletonOf
description: A placeholder that measures the content instead of guessing it - the shape that was on screen, drawn back while the next load is in flight.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/skeleton-of.json
```

<Stand component="skeleton-of" caption="Load the list, ask again, and the placeholder is the shape that was there - grow it to six rows and the placeholder follows." />
