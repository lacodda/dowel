---
title: Skeleton
description: A placeholder shaped like the thing still loading - because a skeleton of the wrong shape is worse than none.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/skeleton.json
```

<Stand component="skeleton" caption="A paragraph, a list, two grids, and single blocks." />
