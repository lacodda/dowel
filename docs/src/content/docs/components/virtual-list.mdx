---
title: VirtualList
description: A hundred thousand rows that puts a screenful in the DOM, and keeps the scrollbar honest.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/virtual-list.json
```

<Stand component="virtual-list" caption="A hundred thousand rows, taller rows, and none at all." />
