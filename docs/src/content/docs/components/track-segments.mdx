...
description: The arithmetic behind Track - spans into percentages, with a floor under the short ones - and no React in it.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/track-segments.json
```

<Stand component="track-segments" caption="The numbers, printed rather than drawn: a sliver widened to the floor, and two slivers that must not overlap." />
