---
title: ColorField
description: 'Picking a colour for something the product stores: a tag, a project, a calendar.'
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/color-field.json
```

<Stand component="color-field" caption="The line's palette, and a colour of the reader's own." />
