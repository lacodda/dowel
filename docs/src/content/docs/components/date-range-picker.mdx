...
description: Two days chosen in two clicks, and the half-made range in between.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/date-range-picker.json
```

<Stand component="date-range-picker" caption="Empty, half made, whole, and bounded." />
