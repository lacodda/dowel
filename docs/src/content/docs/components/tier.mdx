---
title: Tier
description: The band a score falls in, the road of bands drawn to scale, and one axis of the judgement that produced it.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/tier.json
```

<Stand component="tier" caption="Verdicts as badges, four scores on the same road, and three axes - two you can set with the pointer or the arrow keys, one read-only." />
