---
title: ConfirmDialog
description: The dialog for a choice that cannot be taken back - announced as an alert dialog, and not dismissed by clicking away.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/confirm-dialog.json
```

The component lands in `components/ui/confirm-dialog.tsx` and is yours to edit.

<Stand component="confirm-dialog" caption="The three sizes, with a destructive action - in either theme, and in the accent of any product of the line." />
