---
title: diff-lines
description: The comparison behind DiffView - an exact line diff, and the pairing that makes two columns line up.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/diff-lines.json
```

<Stand component="diff-lines" caption="The changes and the rows they pair into, printed rather than drawn - including the insertion that pushes a filtered pair of columns out of step." />
