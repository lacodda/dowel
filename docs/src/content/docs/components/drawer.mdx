---
title: Drawer
description: A modal panel that slides in from an edge - a filter sheet, a detail pane, a form too long to centre.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/drawer.json
```

The component lands in `components/ui/drawer.tsx` and is yours to edit.

<Stand component="drawer" caption="The three sides - right, left and a bottom sheet - in either theme, and in the accent of any product of the line." />
