---
title: FileDrop
description: 'A place to put files: drag them onto it, or press it and pick them.'
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/file-drop.json
```

<Stand component="file-drop" caption="Taking files, filtering them, and closed." />
