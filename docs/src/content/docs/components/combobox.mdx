---
title: Combobox
description: A Select you can type in - it filters, and it has chips.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/combobox.json
```

<Stand component="combobox" caption="Filtering as it is typed, the empty state, and the multiple case with chips." />
