---
title: Toast
description: Something that just happened, said briefly and then gone.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/toast.json
```

The component lands in `components/ui/toast.tsx` and is yours to edit.

<Stand component="toast" caption="Every tone, with a title, a sentence, an action and a dismiss - in either theme, and in the accent of any product of the line." />
