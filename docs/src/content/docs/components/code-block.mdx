---
title: CodeBlock
description: Code shown inside a product - the frame, the gutter, the copy button. The highlighter is deliberately yours.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/code-block.json
```

<Stand component="code-block" caption="A command with no colour at all, a file with line numbers and two lines marked, and the same source coloured by a highlighter." />
