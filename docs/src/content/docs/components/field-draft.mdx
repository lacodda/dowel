---
title: FieldDraft
description: The rules between a value stored somewhere and the text someone is typing over it, as a hook to spread on an input.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/field-draft.json
```

<Stand component="field-draft" caption="An input and a textarea over a stored value, with the stored value beside them and a write from outside." />
