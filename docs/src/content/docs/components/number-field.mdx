---
title: NumberField
description: A number, its stepper, and what an empty box actually means.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/number-field.json
```

<Stand component="number-field" caption="With a stepper and without, with a unit, and formatted as a currency." />
