---
title: Splash
description: What the window shows while the application is opening - the mark, the name, the version and a bar that sweeps until there is something to draw.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/splash.json
```

<Stand component="splash" caption="The full picture inside a box, sweeping and still, with and without the two lines only the application can say." />
