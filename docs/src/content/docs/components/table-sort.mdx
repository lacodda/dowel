---
title: table-sort
description: How a column is ordered, with no React in it - and the one rule a two-line sort gets wrong.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/table-sort.json
```

<Stand component="table-sort" caption="The same six rows sorted by score, ascending and descending." />
