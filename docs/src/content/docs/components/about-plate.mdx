---
title: AboutPlate
description: What a product says about itself on its About screen - mark, name, version, promise, and that it belongs to the lacodda line - in one shape across the line.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/about-plate.json
```

<Stand component="about-plate" caption="Two products' plates side by side, one with a licence and links added." />
