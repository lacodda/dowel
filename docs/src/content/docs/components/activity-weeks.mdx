...
description: Laying a run of dates out in weeks, with the four meanings of a cell - and no React in it.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/activity-weeks.json
```

<Stand component="activity-weeks" caption="The numbers, printed rather than drawn: four kinds of cell, and where a value lands on the scale." />
