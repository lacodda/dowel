---
title: calendar-math
description: The date arithmetic under the Calendar, importable on its own - strings in, strings out, no Date and no library.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/calendar-math.json
```

<Stand component="calendar-math" caption="The functions answering the dates that break naive date code." />
