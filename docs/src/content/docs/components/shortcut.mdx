---
title: Shortcut
description: Binding a keystroke, with the two things every product gets subtly wrong already decided.
---

import Stand from '../../../components/Stand.astro'

```console
$ npx shadcn@latest add https://lacodda.github.io/dowel/r/shortcut.json
```

<Stand component="shortcut" caption="A bound shortcut, and a field it deliberately does not fire into." />
