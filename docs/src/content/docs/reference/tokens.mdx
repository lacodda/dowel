...
<TokenTable
  caption="What stays legible on a status fill, worked out the same way `on-accent` is."
  tokens={['on-good', 'on-warn', 'on-bad', 'on-info']}
/>
...
<TokenTable
  caption="Series identity. Assigned 1..8 in order and never cycled: a ninth series folds into an *other*, or the chart becomes small multiples."
  tokens={['series-1', 'series-2', 'series-3', 'series-4', 'series-5', 'series-6', 'series-7', 'series-8']}
/>
...
<TokenTable
  caption="Magnitude rather than identity: one hue, running away from the ground as the value grows. A heatmap cell reads this."
  tokens={['scale-100', 'scale-200', 'scale-300', 'scale-400', 'scale-500', 'scale-600', 'scale-700']}
/>
...
<TokenTable
  caption="Heat: five discrete steps for a grid of cells where colour is the only thing carrying the value."
  tokens={['heat-1', 'heat-2', 'heat-3', 'heat-4', 'heat-5']}
/>
...
<TokenTable
  caption="The chart's own furniture, quieter than `line`: a gridline that competes with the data is drawn wrong."
  tokens={['chart-grid', 'chart-axis']}
/>
...
<TokenTable
  caption="Syntax: the eight kinds of thing in a piece of code that are worth telling apart in every language."
  tokens={[
    'syntax-keyword',
    'syntax-string',
    'syntax-number',
