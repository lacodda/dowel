...
**v0.4.0.** The theme and its scales, an accent for each of the fourteen
products of the line, and the first primitive through the pipeline. Both the
theme and the components install from the registry with `npx shadcn add`.
